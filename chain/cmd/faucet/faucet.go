...
import (
	...
	"github.com/Tinachain/Tina/chain/ethstats"
	"github.com/Tinachain/Tina/chain/les"
	"github.com/Tinachain/Tina/chain/log"
	"github.com/Tinachain/Tina/chain/node"
	"github.com/Tinachain/Tina/chain/p2p"
	"github.com/Tinachain/Tina/chain/p2p/discover"
	"github.com/Tinachain/Tina/chain/p2p/discv5"
	"github.com/Tinachain/Tina/chain/p2p/nat"
...
func (f *faucet) apiHandler(conn *websocket.Conn) {
	...
	for {
		...
		default:
			err = errors.New("Something funky happened, please open an issue at https://github.com/Tinachain/Tina/chain/issues")
		}
		if err != nil {
			if err = sendError(conn, err); err != nil {
		...
		if timeout = f.timeouts[username]; time.Now().After(timeout) {
			...
			tx := types.NewTransaction(protocol.Normal, protocol.MinMinor, f.nonce+uint64(len(f.reqs)), address, amount, big.NewInt(21000), f.price, nil)
